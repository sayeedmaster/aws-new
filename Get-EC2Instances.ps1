...
try {
    ...
    Write-Host "============================" -ForegroundColor Cyan
    Write-Host "Script version: 12.8 (EC2 Inventory + AMI Usage Reporting with PowerShell modules, SSORole, CIDRBlock, additional attributes, region-specific filenames, fixed termination/shutdown attributes, fixed VpcOwnerId/VpcIsShared, updated AccountName derivation)" -ForegroundColor Green
