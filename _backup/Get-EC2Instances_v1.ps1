...
try {
    ...
    Write-Host "============================" -ForegroundColor Cyan
    Write-Host "Script version: 12.7 (EC2 Inventory + AMI Usage Reporting with PowerShell modules, SSORole, CIDRBlock, additional attributes, region-specific filenames, fixed termination/shutdown attributes, and fixed VpcOwnerId/VpcIsShared)" -ForegroundColor Green
