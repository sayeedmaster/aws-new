...
# Version 12.12: Added PatchGroup and AutoPatch as distinct CSV fields
...
try {
    ...
    Write-Host "============================" -ForegroundColor Cyan
    Write-Host "Script version: 12.12 (EC2 Inventory + AMI Usage Reporting with PowerShell modules, SSORole, CIDRBlock, additional attributes, region-specific filenames, fixed termination/shutdown attributes, fixed VpcOwnerId/VpcIsShared, updated AccountName derivation, added EC2 tag key validation, fixed space detection in tag keys, added PatchGroup and AutoPatch fields)" -ForegroundColor Green
